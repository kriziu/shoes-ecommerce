      ...
      {opened && (
        <>
          ...
          >
            ...
            <Anchor handleClose={handleClose} index={0} title="Men" />
            <Anchor handleClose={handleClose} index={1} title="Women" />
            <Anchor handleClose={handleClose} index={2} title="Kids" />
            <Anchor handleClose={handleClose} index={3} title="Unisex" />
          </motion.div>
        </>
      )}
    </AnimatePresence>
